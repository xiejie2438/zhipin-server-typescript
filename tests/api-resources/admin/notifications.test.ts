...
describe('resource notifications', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = client.admin.notifications.list();
  ...
  test.skip('markAllAsRead', async () => {
    const responsePromise = client.admin.notifications.markAllAsRead();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('markAsRead', async () => {
    const responsePromise = client.admin.notifications.markAsRead(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
