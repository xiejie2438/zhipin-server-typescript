...
describe('resource files', () => {
  ...
  test.skip('uploadFile: only required params', async () => {
    const responsePromise = client.v1.enterprise.files.uploadFile({
  ...
  test.skip('uploadFile: required and optional params', async () => {
    const response = await client.v1.enterprise.files.uploadFile({
      file: await toFile(Buffer.from('Example data'), 'README.md'),
    });
  });
  ...
  test.skip('uploadImage: only required params', async () => {
    const responsePromise = client.v1.enterprise.files.uploadImage({
      file: await toFile(Buffer.from('Example data'), 'README.md'),
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('uploadImage: required and optional params', async () => {
    const response = await client.v1.enterprise.files.uploadImage({
      file: await toFile(Buffer.from('Example data'), 'README.md'),
      type: 'type',
    });
  });
