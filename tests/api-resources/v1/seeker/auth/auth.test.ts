...
describe('resource auth', () => {
  ...
  test.skip('logout', async () => {
    const responsePromise = client.v1.seeker.auth.logout();
  ...
  test.skip('refresh: only required params', async () => {
    const responsePromise = client.v1.seeker.auth.refresh({
  ...
  test.skip('refresh: required and optional params', async () => {
    const response = await client.v1.seeker.auth.refresh({
      refreshToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...',
    });
  });
  ...
  test.skip('register: only required params', async () => {
    const responsePromise = client.v1.seeker.auth.register({
      code: '1234',
      name: '张三',
  ...
  test.skip('register: required and optional params', async () => {
    const response = await client.v1.seeker.auth.register({
      code: '1234',
      name: '张三',
      password: 'password123',
      phone: '13800138000',
