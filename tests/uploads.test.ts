import fs from 'fs';
import type { ResponseLike } from 'zhipin-server/internal/to-file';
import { toFile } from 'zhipin-server/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('zhipin-server/core/uploads');
    await expect(
